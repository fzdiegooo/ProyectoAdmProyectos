...
if (isset($_POST['accion'])) {
    ...
    } elseif ($_POST['accion'] === 'actualizarAdmin') {
...
<head>
    ...
    <title>Admin - Datos Personales</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">
                            <i class="fas fa-user-cog mr-2"></i>Datos del Administrador
                        </h1>
                    </div>
                            ...
                            <div class="card security-card">
                                <div class="security-header">
                                    ...
                                    <p class="mb-0 mt-2 opacity-75">
                                        Protege tu cuenta de administrador con una capa adicional de seguridad
                                    </p>
                                </div>
                                <div class="card-body p-4">
                                    ...
                                    <?php if ($secret_actual): ?>
                                        ...
                                        <div class="alert alert-success" role="alert">
                                            ...
                                            <strong>¡Excelente!</strong> Tu cuenta de administrador está protegida con autenticación en dos pasos.
                                        </div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="alert alert-warning" role="alert">
                                            ...
                                            <strong>Altamente recomendado:</strong> Como administrador, es crucial que actives la autenticación en dos pasos.
                                        </div>
                                    ...
                                    <div class="info-section">
                                        <h6 class="mb-2">
                                            <i class="fas fa-info-circle mr-2"></i>Importancia del 2FA para Administradores
                                        </h6>
                                        <p class="text-muted small mb-0">
                                            Como administrador, tienes acceso a información crítica del sistema. El 2FA es esencial para proteger no solo tu cuenta, sino también todos los datos de la empresa y clientes. Incluso si alguien obtiene tu contraseña, no podrá acceder sin el código de tu teléfono.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-triangle mr-2"></i>
                        <strong>Advertencia:</strong> Como administrador, tu cuenta será significativamente menos segura sin 2FA activado.
                    </div>
                </div>
    ...
    <script>
        document.getElementById('actualizarAdmin').addEventListener('submit', function(e) {
            e.preventDefault();
            
            let formData = new FormData(this);
            formData.append('accion', 'actualizarAdmin');
            
            fetch('datos_admin.php', {
                method: 'POST',
                body: formData
            })
